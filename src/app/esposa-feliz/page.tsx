...
export default function EsposaFelizPage() {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {/* Hero Banner */}
      <header className="bg-gradient-to-r from-[#F4B6B9] to-[#DAA520] rounded-lg text-white py-14 px-4 text-center">
        ...
        <section className="text-center mb-16">
          <p className="text-gray-700 max-w-3xl mt-1 mx-auto text-lg">
            ...
            Seja uma <span className="font-semibold text-[#F4B6B9]">Esposa Feliz</span> e espalhe carinho pelo mundo.
          </p>
        </section>
        ...
        <section className="mt-20 text-center">
          <div className="bg-white rounded-2xl p-8 border border-[#F4B6B9]/30 shadow-sm max-w-3xl mx-auto">
            ...
            <button className="bg-[#DAA520] text-white px-8 py-3 rounded-full font-medium hover:bg-[#c8961e] transition">
              Começar Agora
            </button>
          </div>
        </section>
