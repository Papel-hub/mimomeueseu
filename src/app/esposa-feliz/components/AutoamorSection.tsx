    ...
    <section className="mb-20">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-3 h-10 bg-[#F4B6B9] rounded-full"></div>
          <FaHandHoldingHeart size={32} className="text-[#F4B6B9]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {['Carta de Amor para Mim', 'Cesta Autoamor com Flores', 'Experiência Sensorial Mimo'].map((item, i) => (
            <div key={i} className="border border-[#FDE8E9] rounded-xl p-4 text-center hover:bg-[#FDE8E9] transition">
              <div className="text-[#F4B6B9] font-bold mb-2">•</div>
              <p>{item}</p>
            </div>
          ))}
        </div>
        <button className="mt-6 bg-[#F4B6B9] text-white px-6 py-2 rounded-full text-sm font-medium hover:bg-[#e89fa2] transition">
