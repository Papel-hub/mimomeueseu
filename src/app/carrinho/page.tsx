        ...
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            {cartItems.map((item) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Se for carta, mostra o conteúdo */}
                  {item.title?.toLowerCase().includes("carta") && item.message && (
                    <div className="relative flex justify-center mt-4">
                      ...
                      <div
                        className="mt-2 w-[35%] text-xs absolute
                       top-[62%] left-[8%] text-gray-700 italic 
                       whitespace-pre-line break-words
                        max-h-[120px] overflow-hidden"
                      >
                        {item.message || "Sua mensagem..."}
                      </div>
                    </div>
                  )}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
              ...
              <button
                onClick={() =>
                  router.push(`/pagamento?amount=${encodeURIComponent(cartTotal)}`)
                }
